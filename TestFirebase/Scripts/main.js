...
Chat.prototype.loadMessages = function () {
    ...
    this.messagesRef = this.database.ref('id_' + time);
...
Chat.prototype.onAuthStateChanged = function (user) {
    if (user) { // User is signed in!
        ...
        var profilePicUrl = user.photoURL;   // Thay đổi ảnh của user
        var userName = user.displayName;     // Thay đổi tên hiển thị của user
...
Chat.prototype.checkSignedInWithMessage = function () {
    ...
    // trả về true khi user đã đăng nhập vào firebase
...
Chat.prototype.requestNotificationsPermissions = function () {
    ...
    // đặt quyền hiển thị thông báo mỗi khi có tin mới
